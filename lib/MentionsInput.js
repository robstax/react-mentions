...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleChange = function (ev) {
    ...
    var beforeMentions = _utils2.default.getMentions(value, _this2.props.markup);
    ...
    if (startOfMention !== undefined && _this2.state.selectionEnd > startOfMention && beforeMentions.length !== mentions.length) {
    ...
    mentions = _utils2.default.getMentions(newValue, _this2.props.markup);
