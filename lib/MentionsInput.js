...
var MentionsInput = _react2.default.createClass({
  ...
  render: function render() {
    ...
    var tstyle = (0, _omit2.default)(substyle(this.props, getModifiers(this.props)), ['_radiumDidResolveStyles']);
    return _react2.default.createElement(
      'div',
      (0, _extends4.default)({ ref: 'container' }, tstyle),
      this.renderControl(),
  ...
  getInputProps: function getInputProps(isTextarea) {
    ...
    var props = (0, _omit2.default)(this.props, (0, _keys4.default)(MentionsInput.propTypes));

    var renderSuggestions = (0, _keys2.default)(this.state.suggestions).length > 0;
    if (this.state.changedMention || this.props.value && this.props.value.length === 0 || renderSuggestions) {
      props.value = this.getPlainText();
    }

    return (0, _extends4.default)({}, props, substyle(this.props, getModifiers(this.props, "input")), !readOnly && !disabled && {
  ...
  handleChange: function handleChange(ev) {
    ...
    var beforeMentions = _utils2.default.getMentions(value, this.props.markup);
    ...
    if (startOfMention !== undefined && this.state.selectionEnd > startOfMention && beforeMentions.length !== mentions.length) {
  ...
  updateSuggestions: function updateSuggestions(queryId, mentionDescriptor, query, querySequenceStart, querySequenceEnd, plainTextValue, suggestions) {
    ...
    var suggestionsCount = _utils2.default.countSuggestions(this.suggestions);
