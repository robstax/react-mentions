...
var SuggestionsOverlay = function (_Component) {
  ...
  (0, _createClass3.default)(SuggestionsOverlay, [{
    ...
    value: function componentDidUpdate() {
      var _refs = this.refs,
          suggestions = _refs.suggestions,
          suggestionsContainer = _refs.suggestionsContainer;

      if (!suggestions || suggestionsContainer.offsetHeight >= suggestionsContainer.scrollHeight || !this.props.scrollFocusedIntoView) {
        return;
      }

      var scrollTop = suggestionsContainer.scrollTop;
      ...
      var _suggestionsContainer = suggestionsContainer.getBoundingClientRect(),
          topContainer = _suggestionsContainer.top;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        (0, _extends3.default)({ ref: 'suggestionsContainer'
        }, substyle(this.props), {
          onMouseDown: this.props.onMouseDown }),
        _react2.default.createElement(
          'ul',
          (0, _extends3.default)({ ref: 'suggestions'
...
SuggestionsOverlay.propTypes = {
  suggestions: _react.PropTypes.object.isRequired,
  focusIndex: _react.PropTypes.number,
  scrollFocusedIntoView: _react.PropTypes.bool,
